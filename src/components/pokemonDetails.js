...
class PokemonDetails extends Component {
  ...
  .then(json => {this.setState({pokemon: json}); this.setState({catched:json.catched});})
  }
...
<Container className="d-flex flex-row justify-content-center">
    ...
    <Card.Title># {this.props.match.params.id} <h2 className="top-name center-block text-center ">{this.state.pokemon.name}</h2></Card.Title>
